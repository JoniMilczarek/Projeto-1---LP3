 ...
 */
package com.mycompany.talentomotoracing.service;

import com.mycompany.talentomotoracing.Pessoa;
 ...
 */
@Stateless
@Path("com.mycompany.talentomotoracing.pessoa")
public class PessoaFacadeREST extends AbstractFacade<Pessoa> {

    @PersistenceContext(unitName = "persitence.talento")
